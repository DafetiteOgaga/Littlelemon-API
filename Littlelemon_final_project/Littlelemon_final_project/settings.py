"""
Django settings for Littlelemon_final_project project.
...
SECRET_KEY = 'django-insecure-dkp6yfrx2@4p-_cz=feewkqz-^z4wa=z6lzw1n)9ewp06p6=v5'
...
INSTALLED_APPS = [
    ...
    # 'rest_framework_simplejwt',		# <- added rest_framework_simplejwt here
...
ROOT_URLCONF = 'Littlelemon_final_project.urls'
...
WSGI_APPLICATION = 'Littlelemon_final_project.wsgi.application'
...
# Added drf to the settings.py file
REST_FRAMEWORK = {
...
# Added static to the settings.py file
STATICFILES_DIRS = [
    BASE_DIR / 'static',		# <- added static to BASE_DIR
    BASE_DIR / 'static/Littlelemon_final_project',		# <- added static to project dir
]

# Added djoser variable to the settings.py file
